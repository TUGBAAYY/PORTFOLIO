    ...
    <section className="contact container section" id='contact'>
      ...
      <div className="contact__container grid">
        <div className="contact__info">
          <h3 className="contact__title">Lorem ipsum dolor sit.</h3>
          <p className="contact__details">Lorem ipsum dolor sit amet.</p>
        </div>
        <form action="" className="contact__form">
          <div className="contact__form-group">
            ...
            <div className="contact__form-div contact__form-area">
              <textarea name="" id="" cols="30" rows="10" className="contact__form-input" placeholder='writw your message'></textarea>
            </div>
